class TripDayInfo {
  ...
  TripDayInfo copyWithWeather({
    ...
    return TripDayInfo(
      ...
      fullWeekdayLabel: fullWeekdayLabel,
      isoDate: isoDate,
  ...
  static List<TripDayInfo> generateDaysForTrip({
    ...
    for (int i = 0; i < count; i++) {
      ...
      final iso = '${current.year}-${current.month.toString().padLeft(2, '0')}-${current.day.toString().padLeft(2, '0')}';
